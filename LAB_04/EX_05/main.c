...
void riempiPuntatore(tratte vett[],int size,tratte **ptrData);
...
comando_e leggiComando(){
    char selezione[S];
    char tabella[r_fine+1][S]={"stampa","ordinaData","ordinaCodtratta","ordinaPartenza","ordinaArrivo","ricercaPartenza","fine"};
